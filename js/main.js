...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (typeof initYearlySection === "function")
    initYearlySection("#yearlySection");
...
window.updateAll = function () {
  ...
  if (typeof updateYearlySection === "function")
    updateYearlySection(window.state);
  if (typeof updateKeywordGraph === "function")
    updateKeywordGraph(window.state);
